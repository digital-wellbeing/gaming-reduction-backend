...
## Correcting Per-Protocol Power Calculations

```{r correct-protocol-power}
#| label: correct-protocol-power
#| code-summary: "Correct the per-protocol robust power calculation"
...
```{r visualize-correction-impact}
#| label: visualize-correction-impact
#| code-summary: "Visualize the impact of correcting the robust approach power calculation"

# Create a visual demonstration of the likely impact
if (exists("power_results_multi")) {
  # Create a comparison plot
  comparison_data <- power_results_multi %>%
    select(effect_min, s_between, s_within, power_protocol_change, power_protocol_robust) %>%
    mutate(
